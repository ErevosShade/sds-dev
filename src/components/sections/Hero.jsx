    ...
    >
      ...
      <div ref={textRef} style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", justifyContent: "center", padding: "0 clamp(24px, 6vw, 96px)", maxWidth: 920, zIndex: 2 }}>
        ...
        <div className="hero-cta" style={{ display: "flex", gap: 12, marginTop: 40 }}>
          <a href="/#connect" style={{ fontFamily: "var(--font-body)", fontSize: "var(--text-sm)", letterSpacing: "0.04em", color: "var(--paper-white)", textDecoration: "none", padding: "11px 28px", background: "var(--data-blue)", borderRadius: "var(--radius-sm)", border: "1px solid var(--data-blue)", transition: "opacity 0.2s" }}
            onMouseEnter={e => e.currentTarget.style.opacity = "0.85"} onMouseLeave={e => e.currentTarget.style.opacity = "1"}>
            Join SDS
          </a>
          <a href="/#projects" style={{ fontFamily: "var(--font-body)", fontSize: "var(--text-sm)", letterSpacing: "0.04em", color: "rgba(238,233,220,0.6)", textDecoration: "none", padding: "11px 28px", background: "transparent", borderRadius: "var(--radius-sm)", border: "1px solid rgba(255,255,255,0.12)", transition: "border-color 0.2s, color 0.2s" }}
